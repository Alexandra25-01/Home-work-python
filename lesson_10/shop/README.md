...
- **Название теста**: Например, `Покупка нескольких товаров и проверка итоговой суммы`.
- **Описание теста**: Проверка добавления товаров, оформления заказа и итоговой суммы.
- **Шаги теста**:
